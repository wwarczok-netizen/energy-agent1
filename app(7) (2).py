...
st.caption("Importer v16+: pełny odczyt wszystkich arkuszy XLS/XLSX, bez obcinania do jednego PPE lub 8760 wierszy.")
...
cols[2].metric("Zużycie łączne", fmt_mwh(df["consumption_kwh"].sum()/1000))
...
c1.metric("Zużycie roczne", fmt_mwh(load.sum()/1000))
